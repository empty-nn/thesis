...
class MarkdownChunker:
    ...
    def chunk(self, markdown: str) -> MarkdownChunkerResult:
        ...
        try:
            ...
            for doc in header_docs:
                header_metadata = dict(doc.metadata)
                section_heading = self._get_section_heading(header_metadata)
    ...
    def _get_section_heading(self, metadata: Dict[str, Any]) -> Optional[str]:
